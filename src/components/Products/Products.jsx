    ...
    <main className={classes.mainPage}>
      ...
      <div className={classes.hero}>
        ...
        <div className={classes.heroCont}>
          ...
          Nile River Books Online platform tailored for book enthusiasts in Africa.
          </h1>
          <h3 className={classes.heroDesc} ref={sectionRef}>
          Purpose: Allows users to discover and purchase books related to East Africa.
          Features: Easy search by title, author, or topic. Seamless shopping cart integration.
          </h3>
        ...
        <div className={classes.categorySection}>
          ...
          <div className={classes.buttonSection}>
            <div>
              ...
              <div className={classes.categoryName}>East African Literature</div>
            </div>
            <div>
              <Link to="biography">
                <button
              ...
              <div className={classes.categoryName}>East African Biography</div>
            </div>
            <div>
              <Link to="fiction">
                <button
              ...
              <div className={classes.categoryName}>East African Fiction</div>
            </div>
          </div>
        </div>
      )}
